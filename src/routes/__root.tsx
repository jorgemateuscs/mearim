...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Dashboard completo para gerenciar vendas, clientes, estoque, financeiro e equipe do seu negócio." },
      { property: "og:title", content: "Gestão — Sistema de Gestão Comercial" },
      { property: "og:description", content: "Dashboard completo para gerenciar vendas, clientes, estoque, financeiro e equipe do seu negócio." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Gestão — Sistema de Gestão Comercial" },
      { name: "twitter:description", content: "Dashboard completo para gerenciar vendas, clientes, estoque, financeiro e equipe do seu negócio." },
